...
class DeleteNameConfirmPopup : public Popup<FLAlertLayer*, LevelInfoLayer*> {
    FLAlertLayer*   m_alert = nullptr;
    LevelInfoLayer* m_info  = nullptr;
    TextInput*      m_input = nullptr;

    bool setup(FLAlertLayer* alert, LevelInfoLayer* info) override {
        m_alert = alert;
        m_info  = info;
    ...
    void onClose(CCObject* sender) override {
        ...
        Popup<FLAlertLayer*, LevelInfoLayer*>::onClose(sender);
    }
